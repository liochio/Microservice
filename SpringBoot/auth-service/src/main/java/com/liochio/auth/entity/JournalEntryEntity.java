 ...
 * ==============================================================================
 * 
 * Mỗi bút toán gắn liền với chuỗi mã băm SHA-256 (prev_hash -> current_hash),
 * đảm bảo không thể chỉnh sửa hoặc xóa lịch sử kế toán.
 */
@Entity
...
public class JournalEntryEntity {
    ...
    @Builder.Default
    private String prevHash = "GENESIS_HASH";
