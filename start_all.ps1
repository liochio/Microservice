...
Write-Host "[4/12] Starting Entity Service (:8082)..." -ForegroundColor Yellow
...
Write-Host "[5/12] Starting Notification Service (:8084)..." -ForegroundColor Yellow
...
Write-Host "[6/12] Starting Payment Service (:8085)..." -ForegroundColor Yellow
...
# 7. Dedicated OTP Service (:8094)
Write-Host "[7/12] Starting SmartOTP Service (:8094)..." -ForegroundColor Yellow
...
# 8. Dedicated Worker Service (:8095)
Write-Host "[8/12] Starting Worker Service (:8095)..." -ForegroundColor Yellow
...
# 9. Python FinTech AI Core (:8000)
Write-Host "[9/12] Starting Python FinTech AI Core (:8000)..." -ForegroundColor Yellow
...
# 10. SuperAdmin Portal (:5170)
Write-Host "[10/12] Starting SuperAdmin Portal (:5170)..." -ForegroundColor Yellow
...
# 11. Corporate SaaS Portal (:5171)
Write-Host "[11/12] Starting Corporate SaaS Portal (:5171)..." -ForegroundColor Yellow
Start-Process cmd -ArgumentList '/k "set PATH=C:\Program Files\nodejs;%PATH%&& cd /d d:\Github\Back-end\Microservice\frontend\liochio-corp-fintech && npm run dev"'

# 12. Retail FinTech Portal (:5172)
Write-Host "[12/12] Starting Retail FinTech Portal (:5172)..." -ForegroundColor Yellow
Start-Process cmd -ArgumentList '/k "set PATH=C:\Program Files\nodejs;%PATH%&& cd /d d:\Github\Back-end\Microservice\frontend\liochio-retail-fintech && npm run dev"'

Write-Host ""
Write-Host "========================================================================" -ForegroundColor Green
Write-Host " ALL 12 SERVICES HAVE BEEN LAUNCHED!" -ForegroundColor Green
