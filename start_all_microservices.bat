...
echo [4/9] Khởi động Entity & Headless CMS Engine (Port 8082)...
...
echo [5/9] Khởi động Enterprise Notification Service (Port 8084)...
...
echo [6/9] Khởi động Payment & Transaction Service (Port 8085)...
...
echo [7/9] Khởi động Dedicated SmartOTP Service (Port 8094)...
...
echo [8/9] Khởi động Central Worker & Audit Service (Port 8095)...
...
echo [9/9] Khởi động Python FinTech AI Core (Port 8000)...
start "9. Python FinTech AI (:8000)" cmd /k "cd /d %~dp0Python && .\venv\Scripts\python.exe -m uvicorn app.main:app --host 0.0.0.0 --port 8000 --reload"
