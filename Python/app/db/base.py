...
# 1. KHỞI TẠO KHUNG SƯỜN MODEL ORM CHÍNH QUY (BẢO LƯU LOGIC CỦA SẾP)
class Base(DeclarativeBase):
    """Lớp nền tảng để các Model thực thể (User, UserOtp, Notification...) kế thừa"""
    pass

# 2. NẠP BIẾN DATABASE_URL CHUẨN ĐÉT TỪ .ENV QUA INSTANCE SETTINGS
DATABASE_URL = settings.DATABASE_URL

# Khởi tạo engine bọc thép pool kết nối chống lụt connection
