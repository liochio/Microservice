...
class VerificationService:
    ...
    def validate_and_activate_user(
        ...
        try:
            ...
            # 2. Gán Role USER mặc định nếu chưa có
            ...
            if hasattr(db_conn, "rollback"):
                db_conn.rollback()
            raise FintechBaseException(SystemConstants.SYSTEM_ERROR, 500)
    ...
    @staticmethod
    def validate_link_token_and_get_user(db_conn: Session, token: str, trace_id: str) -> dict:
